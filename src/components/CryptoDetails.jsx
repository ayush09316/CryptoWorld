...
const CryptoDetails = () => {
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <img src={cryptoDetails.iconUrl} alt=''height={'50px'} width={'50px'}/>
      ...
      <Col className='stats-container'>
        <Col className='coin-value-statistics'>
          ...
          {stats.map(({value,title,icon},index)=>(
        ...
        <Col className='coin-stats-info'>
          ...
          {genericStats.map(({value,title,icon},index)=>(
            <Col className='coin-stats' key={Math.random()+index}>
              <Col className='coin-stats-name'>
                <Text>{icon}</Text>
                <Text>{title}</Text>
              </Col>
